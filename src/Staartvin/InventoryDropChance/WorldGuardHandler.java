...
public class WorldGuardHandler {
	...
	protected void registerFlags() {
		if (!plugin.wgClass.isWorldGuardReady()) return;
	...
	{
		customWGFlags = (WGCustomFlagsPlugin) plugin.getServer().getPluginManager().getPlugin("WGCustomFlags");
	  
	  if (customWGFlags == null || !(customWGFlags instanceof WGCustomFlagsPlugin))
	  {
	    return null;
	  }
