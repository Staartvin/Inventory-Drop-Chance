...
public class InventoryDropChance extends JavaPlugin {
	...
	public void loadConfiguration() {
		getConfig().options().header(
				"Inventory Drop Chance v" + getDescription().getVersion() + " Config");

		getConfig().addDefault("verboseLogging", false);
	    ...
	    if (verboseLogging) {
	    	System.out.print("[Inventory Drop Chance] XP loss percentage is " + XPLossPercentage);
	    	System.out.print("[Inventory Drop Chance] Retain percentage is " + retainPercentage);
	    }
